            ...
            <div className='my-dashboard-list'>
              <div className='my-dashboard-links'>
                <ul className='list-unstyled'>
                  <li>
                    <button className={isOrder ? 'active' : ''} onClick={() => handleOrderPage()}>
                      Orders
                    </button>
                  </li>
                  <li>
              ...
              <div>
                <div className='account-order-list'>
                  ...
                  {cartList.length !== 0 ? (
                        ...
                        return (
                          <li>
                            <div className='order-list-wrap'>
                              <div className='date'>Order On: 05-June-2022</div>
                    ...
                    <h1>There is no item being ordered</h1>
                  )}
                </div>
              </div>
            ) : isAddress ? (
                    ...
                    >
                      <div>
                        <div className='address-details'>
                          <h2>
                            {billingDetails['First name']} {billingDetails['Last name']}
                          </h2>
                          <p>
                            {billingDetails['Street Address']} {billingDetails['Town / City']}{' '}
                            {billingDetails['Postcode / ZIP (optional)']}
                          </p>
                          <p>
                            {billingDetails['District']}, {billingDetails['Country / Region']}
                          </p>
