                ...
                <Routes>
                    {routes &&
                        routes.map((route, index) => (
                            ...
                            >
                                {route.children && route.children.map((childroute, i) => (
                                    childroute.path === '' ? <Route index key={i} element={<childroute.element />} /> : <Route path={childroute.path} key={i} element={<childroute.element />} />
                                ))}
                            </Route>))}
