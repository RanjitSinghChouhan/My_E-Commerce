...
function ProductList() {
  ...
  const handleAddToCart = async (product) => {
    ...
    dispatch(addToUserCartApi(form_data))
      .then((response) => {
    ...
    <div className='new-products-container'>
      <h1
        style={{
          marginBottom: '4%',
          height: '50px',
          boxShadow: '0px 0px 4px 0px rgba(175, 105, 105, 0.47)',
        }}
      >
        Products List
      </h1>
      <div className='shop-product-list'>
        {paginatedProductList.map((product) => {
          return (
            <div className='shop-product-wrap' key={product.product_id || product.id}>
              ...
              <div className='content'>
                <div>
                  <div className='price'>
                    ...
                    <span className='discount'>${product.actualPrice || product.price * 1.5}</span>
                  </div>
