...
const cartTable = lazy(() =>
  import('../components/main-body/home/shopping cart/cart-table/CartTable'),
);
const wishList = lazy(() => import('../components/header/second-top/wishlist/WishList'));
const productsList = lazy(() =>
  import('../components/main-body/home/Products/product-list/ProductList'),
);
